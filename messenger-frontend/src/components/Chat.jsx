  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col bg-blue-50 w-3/4 p-2">
              ...
              <div className="overflow-y-scroll absolute top-0 left-0 right-0 bottom-2 p-6">
                {messagesWithoutDupes.map((message) => (
                  ...
                  >
                    <div
                      className={
                        "text-left inline-block p-2 px-4 m-2 rounded-xl text-lg " +
                        (message.sender === id
                      ...
                      {message.file && (
                        <div className="">
                          ...
                          >
                            ...
                            {isImage(message.file) ? "" : message.file}
                          </a>
                        </div>
                      )}
                      <div className="m-0 text-right text-xs">
        ...
        {!!selectedUserId &&
          (onlinePeopleExclOurUser.hasOwnProperty(selectedUserId) ? (
            <form className="flex gap-2" onSubmit={sendMessage}>
              ...
              />
              <label className="bg-blue-200 flex items-center p-4 text-gray-600 cursor-pointer rounded-lg border border-blue-200">
            ...
            <div className="flex justify-center item-center m-0 p-4 border-solid border-slate-400 border-2 rounded-xl">
